...
List<PlaceModel>modles=[
  PlaceModel(id: 1, name: "el falah", latlng:const LatLng(31.292522009334046, 30.014250470849298)),
    PlaceModel(id: 2, name: "el bablo", latlng:const LatLng(31.21386381469122, 29.91194029179508)),
